...
export class SelectionPage implements OnInit {
  ...
  constructor(private router: Router, private dogService: DogService, private alertController: AlertController) { }
  ...
  async presentInformationAlert() {
    const alert = await this.alertController.create({
      header: 'Gestures',
      message: 'One Hand Open: Dog #1, One Hand Pointing: Dog #2, One Hand Closed: Dog#3',
      buttons: ['OK']
    });
